...
#ifndef GEOCAM_SWIFT_H
#define GEOCAM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GeoCam",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6GeoCam20LocationManagerProxy")
...
SWIFT_CLASS("_TtC6GeoCam20MovieCaptureDelegate")
@interface MovieCaptureDelegate : NSObject <AVCaptureFileOutputRecordingDelegate>
...
SWIFT_CLASS("_TtC6GeoCam20PhotoCaptureDelegate")
